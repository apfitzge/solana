...
impl SchedulerController {
    ...
    fn receive_and_buffer_packets(&mut self, decision: &BufferedPacketsDecision) -> bool {
        ...
        let (recv_timeout, recv_limit, should_buffer) = match decision {
            ...
            BufferedPacketsDecision::Forward => {
                (MAX_PACKET_RECEIVE_TIME, DEFAULT_PACKET_RECEIVE_COUNT, false)
            }
            BufferedPacketsDecision::ForwardAndHold | BufferedPacketsDecision::Hold => {
                (MAX_PACKET_RECEIVE_TIME, DEFAULT_PACKET_RECEIVE_COUNT, true)
            }
        };
